...
<jsp:useBean id="fz" class="mybean.date.Fz" scope="session"/>
<jsp:useBean id="gb" class="mybean.date.goodsbean" scope="session"/>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="lookgoods" >主页</a></li>
                   <%
                    CachedRowSetImpl rs=fz.getRowset();
                    if(rs==null){
                    	out.print("没有查询到记录");
                    	return;
                    }
                   	...
                   	{
                   		int id=rs.getInt(1);
                   		String fZhaung=rs.getString(2);
                   		out.print("<li><a href='lookgoods2?name="+id+"''>"+fZhaung+"</a></li>");
...
<div class="hot">
    ...
    CachedRowSetImpl rs1=gb.getRowset();
    if(rs1==null){
    	out.print("没有查询到记录");
    	return;
    }
   	 while(rs1.next())
   	{
   		String good_id=rs1.getString(1);
		String good_name=rs1.getString(2);
		String good_made=rs1.getString(3);
		Float good_price=rs1.getFloat(4);
		String good_message=rs1.getString(5);		
		int good_sl=rs1.getInt(6);
		String good_print=rs1.getString(7);
		int id=rs1.getInt(8);	
	//	out.print("有查询到记录"+good_print);
		out.print("<div class='col-md-4'>");
		out.print(" <h3>"+good_name+"</h3>");
		out.print("<img src='"+good_print+"'class='img-responsive' alt=''>");
		out.print(" <div>");
		out.print("<p class='glyphicon glyphicon-thumbs-up'>两种口味可供选择</p>");
		out.print("<div class='cur'>");
		out.print(" <span ><a class='morebtn' href='#''>添加到购物车</a></span>");
		out.print("<span><h6>一口价 ：￥"+good_price+"</h6></span>");
		out.print(" </div>");
		out.print(" </div>");
		out.print(" </div>");
   	}
    ...
    <!-- 
        <div class="col-md-4 ">
            <h3>米西奈斯煎饼</h3>
            <img src="d://images/1.jpg" class="img-responsive" alt="">
            <div>
